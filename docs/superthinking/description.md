...
- **Media**: image upload/camera/crop; responsive audio playback, live green recording-level feedback, Android screen-off/background recording continuity, waveform trim, and MP3/WAV export (FFmpeg); video upload and YouTube entries
