...
Minimalism demands stronger decisions because every object is exposed. Give each object at least two roles: a circle can be both a bank point and color accent; a solid arch can frame a bonus and guide the ball; one bumper can define the whole ending and guard 3×.

Use scale and negative space. Three well-separated objects should form a triangle, rhythm, or implied curve rather than look abandoned. Align the background's strongest feature with the ball path. Let the rail color, gutter colors, and one foreground accent finish the composition.
...
Think in acts. The upper act establishes the choice; the middle act delivers the board's signature experience; the lower act resolves gutter strategy. A dense board benefits from brief open falls between acts. A sparse board may express the same structure with only three objects.
...
- First-shot routes and partly cleared late-shot routes.
...
Consider the sparse catalog board **One Good Bounce**. Its promise is: “One bumper turns an obvious shot into a meaningful gutter decision.” Build that idea in six deliberate passes:
...
2. Place one large bumper near the upper-middle board and one bonus star lower and to the right. Nothing else is needed for the first graybox.
3. Give the bumper one job: convert entry angle into a left-versus-right decision. Give the star two jobs: advertise the recovery route and punctuate the fall.
4. Test quick, full, and Perfect releases from left, center, and right. Trace the ball all the way to x at y=736; merely hitting the bumper is not success.
5. Test the late state after the one-shot star has disappeared. The board should still produce an interesting bumper-to-well choice rather than becoming empty dead time.
6. Tune by evidence. If center becomes automatic, move the bumper slightly off-axis or lower it. If every bounce becomes random, reduce its radius or give the fall more settling distance. If misses feel barren, add one small path marker—not a decorative field.

This example is intentionally tiny. The same sequence scales to a factory or Rube Goldberg board: promise, gutter hypothesis, essential graybox, material jobs, late state, measured revision.
...
- **Minimal poem** — Use five objects, five distinct contact moments, one muted palette, and one slow ambient motif. Make every hit change the apparent balance of the composition.
...
- **[Minimal Masterpieces](#minimal-masterpieces)** — Simple, sparse, calm, graphic boards where every object matters.
...
- **AF-03 — Pachinko Rain** (Beginner · medium density) — Premise: Create a soft field of many small deflections that reads like rain without becoming visually dense; Geometry/materials: 63 pieces (4 bonus, 46 standard, 4 armored, 8 bumper, 1 multiball) led by 59 circle, 4 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Arcade palette, home ambient, neon rail effects, and a deliberately static foreground; Strategy: manage bumper loops and overload windows, then preserve a clean lower release.
...
- **AF-08 — Pinball Alley** (Intermediate · light density) — Premise: Build a narrow bumper-driven alley with rails that produce controlled rebounds rather than random pinball noise; Geometry/materials: 26 pieces (2 solid, 8 bumper, 13 standard, 2 multiball, 1 bonus) led by 19 circle, 4 hexagon, 2 rectangle; Gutter intent: 1-3-2-3-1 custom payouts place 3× in left-center and right-center; Presentation: Arcade palette, chrome ambient, neon rail effects, and a deliberately static foreground; Strategy: manage bumper loops and overload windows, then preserve a clean lower release.
- **AF-09 — Lucky Horseshoe** (Beginner · light density) — Premise: Use a familiar open horseshoe silhouette to cradle rewards while leaving a clean downward release; Geometry/materials: 38 pieces (2 bumper, 30 standard, 3 armored, 1 bonus, 2 multiball) led by 37 circle, 1 star; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Arcade palette, miami ambient, shock rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **AF-10 — Arcade Ladder** (Intermediate · light density) — Premise: Turn a ladder into a sequence of bankable rungs where climbing across the pattern improves reward quality; Geometry/materials: 26 pieces (10 solid, 6 standard, 3 armored, 5 bumper, 1 multiball, 1 bonus) led by 15 circle, 10 rectangle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 2 lower pieces; Presentation: Arcade palette, outrun ambient, plasma rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.

### Minimal Masterpieces

- **MM-01 — Three Stones** (Relaxed · light density) — Premise: Prove that three carefully spaced circular targets can create a complete aim-and-release puzzle; Geometry/materials: 3 pieces (1 standard, 1 armored, 1 bonus) led by 3 circle; Gutter intent: 1-2-3-1-1 custom payouts place 3× in center; Presentation: Minimal palette, pond ambient, ripple rail effects, and a deliberately static foreground; Strategy: treat every contact and its exit angle as a complete decision.
- **MM-02 — One Good Bounce** (Beginner · light density) — Premise: Center the experience on a single bumper contact that converts a simple shot into a meaningful gutter decision; Geometry/materials: 2 pieces (1 bumper, 1 bonus) led by 1 circle, 1 star; Gutter intent: 1-1-3-2-1 custom payouts place 3× in center; Presentation: Minimal palette, moon ambient, spark rail effects, and a deliberately static foreground; Strategy: treat every contact and its exit angle as a complete decision.
- **MM-03 — Falling Leaf** (Relaxed · light density) — Premise: Trace one drifting leaf-like descent with sparse curved contacts and generous breathing room; Geometry/materials: 9 pieces (7 standard, 1 bonus, 1 solid) led by 4 pentagon, 4 curved, 1 rectangle; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Minimal palette, garden ambient, neon rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **MM-04 — Quiet Arch** (Relaxed · light density) — Premise: Use one restrained arch to shelter a reward and demonstrate how solids can imply architecture without clutter; Geometry/materials: 8 pieces (5 solid, 1 bonus, 2 standard) led by 5 curved, 2 circle, 1 star; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Minimal palette, mandala ambient, shock rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
- **MM-05 — Pendulum** (Intermediate · light density) — Premise: Make one moving weight the entire timing challenge, with static witnesses that reveal its sweep; Geometry/materials: 4 pieces (1 bumper, 2 standard, 1 bonus) led by 2 circle, 1 rectangle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Minimal palette, lotus ambient, plasma rail effects, and 1 rotating group; Strategy: treat every contact and its exit angle as a complete decision.
- **MM-06 — Two Doors** (Beginner · light density) — Premise: Offer two clean openings: one safe and one narrow, valuable route toward the jackpot; Geometry/materials: 5 pieces (2 solid, 1 standard, 1 armored, 1 bonus) led by 2 rectangle, 2 circle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Minimal palette, stars ambient, ripple rail effects, and a deliberately static foreground; Strategy: treat every contact and its exit angle as a complete decision.
- **MM-07 — Negative Space** (Intermediate · light density) — Premise: Let an empty central silhouette—not a filled drawing—be the board's dominant visual and strategic feature; Geometry/materials: 29 pieces (15 standard, 13 armored, 1 bonus) led by 28 circle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 2 lower pieces; Presentation: Minimal palette, prism ambient, spark rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **MM-08 — Mono Steps** (Relaxed · light density) — Premise: Create a quiet grayscale stair descent where each landing changes the ball's horizontal tendency; Geometry/materials: 14 pieces (7 solid, 6 standard, 1 bonus) led by 7 rectangle, 6 square, 1 star; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Minimal palette, grid ambient, neon rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
- **MM-09 — Five Notes** (Beginner · light density) — Premise: Place five material contacts as a visual and rhythmic phrase whose spacing makes the contact order easy to follow; Geometry/materials: 5 pieces (4 standard, 1 bonus) led by 4 circle, 1 star; Gutter intent: 1-2-1-3-1 custom payouts place 3× in right-center; Presentation: Minimal palette, beacon ambient, shock rail effects, and a deliberately static foreground; Strategy: treat every contact and its exit angle as a complete decision.
- **MM-10 — Last Light** (Relaxed · light density) — Premise: Use a nearly empty board and one luminous final reward to make anticipation more important than quantity; Geometry/materials: 1 pieces (1 bonus) led by 1 star; Gutter intent: 1-1-3-1-1 custom payouts place 3× in center; Presentation: Minimal palette, moon ambient, plasma rail effects, and a deliberately static foreground; Strategy: treat every contact and its exit angle as a complete decision.
...
- **JG-02 — Bank Shot** (Intermediate · light density) — Premise: Reward a deliberate wall bank that redirects the ball behind a center guard into the jackpot lane; Geometry/materials: 16 pieces (3 solid, 1 multiball, 2 armored, 8 standard, 1 bumper, 1 bonus) led by 12 circle, 3 rectangle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Jackpot palette, grid ambient, spark rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **JG-03 — Double Bank** (Advanced · light density) — Premise: Require two controlled direction changes while preserving alternate 2× exits when the second bank misses; Geometry/materials: 19 pieces (3 solid, 7 standard, 6 armored, 1 multiball, 1 bumper, 1 bonus) led by 15 circle, 3 rectangle, 1 star; Gutter intent: 1-2-3-1-1 custom payouts place 3× in center; Presentation: Jackpot palette, trace ambient, neon rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
...
- **JG-09 — Twin Temptation** (Advanced · light density) — Premise: Offer two valuable mid-well funnels separated by a low-value center decoy; Geometry/materials: 27 pieces (4 solid, 18 standard, 2 multiball, 2 bonus, 1 bumper) led by 21 circle, 4 rectangle, 2 star; Gutter intent: 1-3-1-3-1 custom payouts place 3× in left-center and right-center; Presentation: Jackpot palette, duel ambient, shock rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
- **JG-10 — Reverse Pyramid** (Intermediate · medium density) — Premise: Use an inverted triangle to gather broad entries into a small armored gate above the center well; Geometry/materials: 68 pieces (21 armored, 46 standard, 1 bonus) led by 67 circle, 1 star; Gutter intent: the center 3× approach is deliberately contested by 8 lower pieces; Presentation: Jackpot palette, prism ambient, plasma rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.

### Material Studies

- **MS-01 — Armor Orchard** (Intermediate · light density) — Premise: Turn durable armored fruit and solid branches into a readable lesson in charge, beam, and staged clearing; Geometry/materials: 14 pieces (5 solid, 7 armored, 1 bonus, 1 multiball) led by 8 circle, 5 rectangle, 1 star; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Materials palette, garden ambient, ripple rail effects, and a deliberately static foreground; Strategy: use charge or Perfect Beam to reduce the armor tax before chasing the richest exit.
- **MS-02 — Bumper Forge** (Intermediate · light density) — Premise: Contrast absorbent solid anvils with energetic bumpers so material response tells the story of a forge; Geometry/materials: 17 pieces (4 solid, 6 bumper, 1 bonus, 6 armored) led by 6 circle, 4 rectangle, 3 hexagon; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Materials palette, acid ambient, spark rail effects, and a deliberately static foreground; Strategy: use charge or Perfect Beam to reduce the armor tax before chasing the richest exit.
- **MS-03 — Multiball Loom** (Advanced · light density) — Premise: Interlace solid warp lines with multiball shuttles to release extra balls in a controlled sequence; Geometry/materials: 13 pieces (7 solid, 3 standard, 2 multiball, 1 bonus) led by 12 rectangle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Materials palette, matrix ambient, neon rail effects, and 5 independently moving targets; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
- **MS-04 — Solid River** (Intermediate · light density) — Premise: Use curved solid banks as a riverbed and scoring stones as intentional current breaks; Geometry/materials: 20 pieces (14 solid, 5 standard, 1 bonus) led by 14 curved, 5 circle, 1 star; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Materials palette, pond ambient, shock rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
...
- **MS-07 — Woodblock Terrace** (Beginner · light density) — Premise: Stack absorbent terraces that slow the fall and punctuate each landing with dry wooden scoring notes; Geometry/materials: 14 pieces (7 solid, 6 standard, 1 bonus) led by 7 rectangle, 6 square, 1 star; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Materials palette, stack ambient, spark rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
- **MS-08 — Paper Circuit** (Intermediate · light density) — Premise: Draw a thin angular circuit from solid traces and destructible square components without using dense peg fields; Geometry/materials: 19 pieces (10 solid, 7 standard, 1 multiball, 1 bonus) led by 10 rectangle, 8 square, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Materials palette, cipher ambient, neon rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
...
- **MS-10 — Armor Keyhole** (Advanced · light density) — Premise: Build a durable keyhole whose beam-clearable rim protects a lucrative center channel; Geometry/materials: 38 pieces (4 bumper, 32 armored, 1 multiball, 1 bonus) led by 35 circle, 2 rectangle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Materials palette, beacon ambient, plasma rail effects, and a deliberately static foreground; Strategy: use charge or Perfect Beam to reduce the armor tax before chasing the richest exit.

### Kinetic Machines

- **KM-01 — Clockwork** (Intermediate · light density) — Premise: Mesh two slow rotating assemblies so their changing openings create a readable mechanical cadence; Geometry/materials: 29 pieces (3 armored, 21 standard, 3 bumper, 1 multiball, 1 bonus) led by 19 circle, 5 octagon, 4 hexagon; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Kinetic palette, tubes ambient, ripple rail effects, and 2 rotating groups; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **KM-02 — Escalator** (Intermediate · light density) — Premise: Slide a sequence of step targets laterally to carry and redirect falling balls across the board; Geometry/materials: 10 pieces (6 standard, 2 multiball, 1 bonus, 1 solid) led by 9 rectangle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Kinetic palette, stack ambient, spark rail effects, and 9 independently moving targets; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
...
- **KM-07 — Bumper Relay** (Intermediate · light density) — Premise: Pass energy through a diagonal series of wobbling bumpers whose spacing supports visible handoffs; Geometry/materials: 16 pieces (8 bumper, 6 standard, 1 multiball, 1 bonus) led by 11 circle, 4 hexagon, 1 star; Gutter intent: the center 3× approach is lightly guarded by 3 lower pieces; Presentation: Kinetic palette, duel ambient, spark rail effects, and 8 independently moving targets; Strategy: manage bumper loops and overload windows, then preserve a clean lower release.
- **KM-08 — Ferris Wheel** (Intermediate · light density) — Premise: Rotate a reward wheel slowly enough that players can choose a carriage and predict its release side; Geometry/materials: 16 pieces (3 multiball, 6 standard, 3 bumper, 1 bonus, 3 solid) led by 9 circle, 4 star, 3 rectangle; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Kinetic palette, home ambient, neon rail effects, and 1 rotating group; Strategy: choose multiball timing before committing the enlarged ball field to a payout lane.
...
- **AA-07 — City Rain** (Intermediate · light density) — Premise: Layer cool vertical rain with a low skyline, allowing falling motion and architecture to reinforce each other; Geometry/materials: 46 pieces (9 solid, 35 standard, 1 multiball, 1 bonus) led by 45 rectangle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 2 lower pieces; Presentation: Atmospheric palette, rain ambient, spark rail effects, and 36 independently moving targets; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
- **AA-08 — Sunset Bridge** (Intermediate · light density) — Premise: Span the board with a warm arch whose openings create distinct above-bridge and below-bridge play; Geometry/materials: 34 pieces (4 armored, 20 solid, 8 standard, 1 multiball, 1 bonus) led by 21 circle, 11 curved, 1 rectangle; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Atmospheric palette, sunset ambient, neon rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
...
- **AA-10 — Cathedral Glass** (Advanced · light density) — Premise: Use a symmetrical stained-glass mosaic whose material colors and shapes identify distinct scoring chapels; Geometry/materials: 33 pieces (14 solid, 8 armored, 7 standard, 2 multiball, 2 bonus) led by 15 hexagon, 8 curved, 6 square; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Atmospheric palette, prism ambient, plasma rail effects, and a deliberately static foreground; Strategy: use charge or Perfect Beam to reduce the armor tax before chasing the richest exit.

### Precision & Strategy

- **PS-01 — Perfect Five** (Advanced · light density) — Premise: Clear a five-armor spine with one beam, then use four separate side targets to complete five successful releases, because one beam clearing five targets advances the streak only once; Geometry/materials: 11 pieces (5 armored, 4 standard, 1 multiball, 1 bonus) led by 8 circle, 2 square, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Precision palette, trace ambient, ripple rail effects, and a deliberately static foreground; Strategy: use charge or Perfect Beam to reduce the armor tax before chasing the richest exit.
- **PS-02 — Armor Tax** (Advanced · light density) — Premise: Place durable toll gates on every safe route while leaving a riskier bypass for confident players; Geometry/materials: 49 pieces (42 armored, 5 standard, 1 multiball, 1 bonus) led by 42 rectangle, 6 circle, 1 star; Gutter intent: 2-1-3-1-2 custom payouts place 3× in center; Presentation: Precision palette, cipher ambient, spark rail effects, and a deliberately static foreground; Strategy: use charge or Perfect Beam to reduce the armor tax before chasing the richest exit.
- **PS-03 — Bumper Heat** (Advanced · light density) — Premise: Make bumper overload a tactical objective while ensuring the tenth contact changes the route rather than only the score; Geometry/materials: 20 pieces (10 bumper, 2 solid, 1 multiball, 6 standard, 1 bonus) led by 11 circle, 5 hexagon, 2 rectangle; Gutter intent: the center 3× approach is lightly guarded by 3 lower pieces; Presentation: Precision palette, signal ambient, neon rail effects, and 5 independently moving targets; Strategy: manage bumper loops and overload windows, then preserve a clean lower release.
...
- **PS-05 — Timed Dropper** (Advanced · light density) — Premise: Use a moving lower gate to convert aim into a combined timing-and-trajectory challenge; Geometry/materials: 49 pieces (5 armored, 40 standard, 1 solid, 1 bonus, 1 multiball, 1 bumper) led by 47 circle, 1 rectangle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 2 lower pieces; Presentation: Precision palette, scroll ambient, plasma rail effects, and 1 independently moving target; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **PS-06 — Crossfire** (Advanced · light density) — Premise: Cross two diagonal target lines so the safest clear and highest-value clear demand different angles; Geometry/materials: 31 pieces (6 armored, 22 standard, 1 bumper, 1 multiball, 1 bonus) led by 29 circle, 2 star; Gutter intent: 2-1-3-1-2 custom payouts place 3× in center; Presentation: Precision palette, grid ambient, ripple rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **PS-07 — Risk Ladder** (Advanced · light density) — Premise: Escalate material value and gutter danger together as the player advances down a side ladder; Geometry/materials: 19 pieces (10 solid, 2 standard, 3 armored, 2 bumper, 1 multiball, 1 bonus) led by 10 rectangle, 7 circle, 2 star; Gutter intent: 3-1-2-1-1 custom payouts place 3× in far-left; Presentation: Precision palette, root ambient, spark rail effects, and a deliberately static foreground; Strategy: use charge or Perfect Beam to reduce the armor tax before chasing the richest exit.
- **PS-08 — Route Memory** (Expert · light density) — Premise: Repeat a visual rhythm with one material variation per row, rewarding players who remember the safe sequence; Geometry/materials: 37 pieces (28 armored, 7 standard, 1 multiball, 1 bonus) led by 28 square, 8 circle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 2 lower pieces; Presentation: Precision palette, matrix ambient, neon rail effects, and a deliberately static foreground; Strategy: use charge or Perfect Beam to reduce the armor tax before chasing the richest exit.
...
- **CC-01 — Bamboo Rain** (Relaxed · light density) — Premise: Let small drops weave between tall absorbent bamboo stems with a gentle left-right rhythm; Geometry/materials: 32 pieces (8 solid, 23 standard, 1 bonus) led by 23 circle, 8 rectangle, 1 star; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Calm palette, rain ambient, ripple rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
- **CC-02 — Zen Garden** (Relaxed · light density) — Premise: Use raked arcs, three stones, and broad empty space to create a slow contemplative board; Geometry/materials: 31 pieces (15 solid, 14 standard, 1 armored, 1 bonus) led by 16 circle, 15 curved; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Calm palette, garden ambient, spark rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
...
- **CC-05 — Wind Chimes** (Relaxed · light density) — Premise: Suspend bars of different lengths, then use spaced material contacts and slight motion to suggest a readable chime-like rhythm without depending on authored pitch; Geometry/materials: 14 pieces (6 solid, 6 standard, 1 multiball, 1 bonus) led by 7 rectangle, 6 circle, 1 star; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Calm palette, lotus ambient, plasma rail effects, and 7 independently moving targets; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
- **CC-06 — Petal Drift** (Relaxed · light density) — Premise: Move a few colorful petal targets slowly across open lanes to create serene timing choices; Geometry/materials: 16 pieces (15 standard, 1 bonus) led by 8 star, 8 pentagon; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Calm palette, kaleido ambient, ripple rail effects, and 16 independently moving targets; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **CC-07 — Slow Spiral** (Intermediate · light density) — Premise: Use a widely spaced spiral with one quiet bumper transition instead of a dense whirlpool; Geometry/materials: 32 pieces (29 standard, 1 bumper, 1 multiball, 1 bonus) led by 31 circle, 1 star; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Calm palette, tunnel ambient, spark rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **CC-08 — River Stones** (Relaxed · light density) — Premise: Place irregular rounded stones as deliberate stepping points across an open current; Geometry/materials: 12 pieces (3 armored, 7 standard, 1 bumper, 1 bonus) led by 11 circle, 1 star; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Calm palette, pond ambient, neon rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **CC-09 — Lantern Descent** (Beginner · light density) — Premise: Alternate glowing lanterns down the board so their zigzag sequence naturally teaches bank direction; Geometry/materials: 15 pieces (6 standard, 7 solid, 1 multiball, 1 bonus) led by 8 star, 7 rectangle; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Calm palette, moon ambient, shock rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
- **CC-10 — Soft Landing** (Relaxed · light density) — Premise: Finish a gentle funnel with absorbent lower shelves that settle trajectories before the wells; Geometry/materials: 22 pieces (15 standard, 4 solid, 2 bumper, 1 bonus) led by 17 circle, 4 rectangle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Calm palette, mandala ambient, plasma rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
...
- **FI-02 — Heartline** (Beginner · light density) — Premise: Draw a heart as two scoring lobes that converge into a center release point; Geometry/materials: 36 pieces (3 armored, 30 standard, 2 multiball, 1 bonus) led by 35 circle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Icons palette, lotus ambient, spark rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **FI-03 — Rocket Launch** (Intermediate · light density) — Premise: Use an upright rocket silhouette with a multiball ignition stage and bumper exhaust; Geometry/materials: 43 pieces (6 armored, 32 standard, 3 bumper, 1 multiball, 1 bonus) led by 30 circle, 11 triangle, 2 star; Gutter intent: the center 3× approach is deliberately contested by 4 lower pieces; Presentation: Icons palette, outrun ambient, neon rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **FI-04 — Pixel Visitor** (Intermediate · light density) — Premise: Translate an arcade alien into a square grid with readable gaps and material-coded features; Geometry/materials: 53 pieces (48 standard, 4 armored, 1 multiball) led by 52 square, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Icons palette, invade ambient, shock rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
...
- **FI-07 — Lightning Bolt** (Intermediate · light density) — Premise: Use an angular bolt to create alternating banks down a fast central descent; Geometry/materials: 45 pieces (6 bumper, 35 standard, 2 armored, 1 multiball, 1 bonus) led by 37 circle, 6 triangle, 2 star; Gutter intent: the center 3× approach is lightly guarded by 2 lower pieces; Presentation: Icons palette, signal ambient, spark rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **FI-08 — Tree of Light** (Intermediate · light density) — Premise: Grow branching reward paths from a solid trunk and end them in luminous scoring leaves; Geometry/materials: 16 pieces (7 solid, 3 multiball, 5 standard, 1 bonus) led by 8 circle, 7 rectangle, 1 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Icons palette, garden ambient, neon rail effects, and a deliberately static foreground; Strategy: choose multiball timing before committing the enlarged ball field to a payout lane.
- **FI-09 — Butterfly** (Intermediate · light density) — Premise: Give two colorful wings distinct rebound personalities around a narrow central body; Geometry/materials: 54 pieces (3 bumper, 42 standard, 1 multiball, 5 armored, 2 bonus, 1 solid) led by 45 circle, 5 star, 3 hexagon; Gutter intent: the center 3× approach is deliberately contested by 5 lower pieces; Presentation: Icons palette, kaleido ambient, shock rail effects, and a deliberately static foreground; Strategy: read the upper motif, collect the best-value targets, and protect the intended final descent.
- **FI-10 — Labyrinth Key** (Advanced · light density) — Premise: Combine a key silhouette with a short solid maze so recognition and route-finding coexist; Geometry/materials: 32 pieces (4 armored, 21 standard, 1 multiball, 4 solid, 1 bonus, 1 bumper) led by 26 circle, 4 rectangle, 2 star; Gutter intent: the center 3× approach is lightly guarded by 1 lower piece; Presentation: Icons palette, cipher ambient, plasma rail effects, and a deliberately static foreground; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
...
- **EE-10 — Grand Machine** (Master · light density) — Premise: Conclude the catalog with a staged mechanism combining timing, solids, bumpers, armor, multiball, and gutter routing; Geometry/materials: 53 pieces (8 armored, 30 standard, 6 solid, 6 bumper, 2 multiball, 1 bonus) led by 42 circle, 6 rectangle, 4 hexagon; Gutter intent: 2-1-3-1-2 custom payouts place 3× in center; Presentation: Experimental palette, orbit ambient, plasma rail effects, and 1 rotating group, 2 independently moving targets; Strategy: read the absorbent solid surfaces first and aim for the rebound sequence they imply.
