...
- **AA-10 — Cathedral Glass** (Advanced · light density) — Premise: Use a symmetrical stained-glass mosaic whose material colors and shapes identify distinct scoring chapels; Geometry/materials: 34 pieces (15 solid, 8 armored, 7 standard, 2 multiball, 2 bonus) led by 15 hexagon, 8 curved, 6 square; Gutter intent: the narrow center 3× approach is intentionally open; Presentation: Atmospheric palette, prism ambient, plasma rail effects, and a deliberately static foreground; Strategy: use charge or Perfect Beam to reduce the armor tax before chasing the richest exit.
