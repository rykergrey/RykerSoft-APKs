...
- **versionCode / versionName**: `26` / `1.0.25`
- **Architectures**: Android `armeabi-v7a`, `arm64-v8a`; Windows `x86_64`
- **Windows packaging**: Portable Godot release EXE with embedded PCK; file/product version `1.0.25.0`
...
- Firebase App Check is staged in observation mode and is not enforced in v1.0.25, allowing telemetry review before a later enforcement rollout
