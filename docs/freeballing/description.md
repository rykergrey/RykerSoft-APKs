...
- **Arcade lobbies** — Portrait and wide desktop homes with accurate native board previews, a dedicated animated neon title stage with fast ribbons, rails, print-head sweeps, and orbiting dots, plus in-place Campaign / Community / Editor / Rankings / Settings panels. Desktop adds a dedicated level browser beside the board preview.
