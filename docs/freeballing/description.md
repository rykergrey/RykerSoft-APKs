...
- **Authenticated leaderboards** — This week / last week / all-time rankings remain anonymously readable, while score submissions are authorized by Firebase Authentication and attributed by the server-owned public username.
